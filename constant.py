...
SERVICE_STATUS['success'] = 2
SERVICE_STATUS['failure'] = 3

#################################################################################################
# 服务来源类型
# 1.内部服务，通过标签选择，2.外部服务，通过IP映射，3.外部服务，通过别名映射
#################################################################################################
SERVICE_SOURCE_TYPE = {
    'by_label': 1,
    'by_ip': 2,
...
#################################################################################################
IMAGE_STATUS = dict()
IMAGE_STATUS['initial'] = 0
IMAGE_STATUS['success'] = 1
IMAGE_STATUS['failure'] = 2
