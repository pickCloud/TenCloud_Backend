...
from handler.server.server import ServerNewHandler, ServerReport, ServerMigratinHandler, ServerDeletionHandler, \
                                  ServerDetailHandler
...
routes = [
    ...
    (r'/api/server/deletion', ServerDeletionHandler),
    (r'/api/server/detail/(\d+)', ServerDetailHandler),
